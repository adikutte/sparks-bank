    ...
    <body>
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="#" class="nav__logo">Aditya</a>
                </div>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    <h1 class="home__title">Hi,<br>I'am <span class="home__title-color">Aditya</span><br>IT Undergraduate</h1>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    ...
                    <div>
                        <h2 class="about__subtitle">I'am Aditya Kutte</h2>
                        <p class="about__text">Currently persuing BE. in Information Technology from Scoe Enginnering College.
                        <br><br>                
                </div>
            </section>
            ...
            <section class="contact section" id="contact">
                ...
                <div class="contact__container bd-grid">
                    <!-- <form action="" class="contact__form">
                        ...
                        <a href="mailto:kutteaditya@gmail.com"><input type="button" value="Send Mail" class="contact__button button" style="background-color:skyblue ; border:2px solid black; color:black ; width:500px"></a>
        ...
        <!--===== FOOTER =====-->
        <footer class="footer">
            <p class="footer__title">Aditya Kutte</p>
